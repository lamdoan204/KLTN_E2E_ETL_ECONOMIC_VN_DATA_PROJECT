...
def extract_data_from_International_Ecommerce(excel_file: pd.ExcelFile, year, month):
    ...
    if year > 2018 or year == 2018 and month >= 9 :
        ...
        insert_df_to_table_silver_layer(import_sheet, 'international_ecommerce')
        insert_df_to_table_silver_layer(export_sheet, 'international_ecommerce')
...
def extract_data_from_Invesment(excel_file: pd.ExcelFile, year, month):
    ...
    for i in range(len(vdt_sheet['investment_name'])):
        num_of_removed_col += 1
        if isinstance(vdt_sheet.iloc[i, 'investment_name'], str):
            break
    ...
    insert_df_to_table_silver_layer(vdt_sheet, 'investment')
...
def extract_primarily_industry_product_data(sheet : pd.read_excel, month, year):
...
def extract_data_for_Product_Productivity_fact(excel_file: pd.ExcelFile, year, month):
    ...
    if month % 3 != 0:
        ...
        # load lên silver với schema nào đó
        insert_df_to_table_silver_layer(df, 'industry_product')
    else: 
        ...
        insert_df_to_table_silver_layer(industry_product_df, 'industry_product')
        ...
        insert_df_to_table_silver_layer(channuoi_sheet, 'livestock')
        ...
        insert_df_to_table_silver_layer(lamnghiep_sheet, 'forestry')
        ...
        insert_df_to_table_silver_layer(thuysan_sheet, 'aquatic_products')
        ...
        if quarter == 4:
            if cay_lau_nam_sheet_index != -1:
                ...
                # lâu năm
                    ...
                    insert_df_to_table_silver_layer(merged_df, 'perennial_crops')
                    ...
                    insert_df_to_table_silver_layer(caylaunam_sheet, 'perennial_crops')
            ...
            if cay_hang_nam_sheet_index != -1 :
                ...
                insert_df_to_table_silver_layer(cayhangnam_sheet,'annual_crops')
            ...
            if cay_trong_chu_yeu_sheet_index != -1:
                ...
                insert_df_to_table_silver_layer(merged_df, 'staple_crops')
